...
export function mockSiteSettings(): SiteSettings {
  return {
    ...
    logo_url: null,
    phone: '07951 999 999',
    email: 'info@chartersgold.co.uk',
    whatsapp: '+447951999999',
    address: "Index House, St George's Lane, Ascot, Berkshire, SL5 7ET",
...
export function mockFaqs(): Faq[] {
  return [
    ...
    },
    {
      ...
      answer:
        'We are based in Ascot, Berkshire, and serve clients across London, Surrey, Berkshire and the Thames Valley - including Windsor, Sunningdale, Heathrow, Reading, Twickenham, Richmond, Egham and Staines. You can visit our office by appointment, we can arrange a private home visit for pieces of significant value, or we accept insured postal valuations from anywhere in the UK. See our Areas We Cover page for region-specific guides.',
      display_order: 10,
      visible: true,
    },
    {
  ...
  return [
    {
      ...
      available_variables: [
        ...
        { key: 'phone', label: 'Customer phone (formatted)', example: '07951 999 999' },
        { key: 'phone_digits', label: 'Customer phone (digits only)', example: '07951999999' },
        ...
        { key: 'logo_url', label: 'Brand logo URL', example: 'https://chartersgold.co.uk/logo/charters_gold_logo.png' },
        { key: 'business_name', label: 'Business name', example: 'Charters Gold' },
        { key: 'address', label: 'Business address', example: 'Index House, Ascot…' },
      ],
      enabled: true,
      updated_at: now,
    },
    {
      ...
      available_variables: [
        ...
        { key: 'business_name', label: 'Business name', example: 'Charters Gold' },
        { key: 'business_phone', label: 'Business phone (formatted)', example: '07951 999 999' },
        { key: 'business_phone_digits', label: 'Business phone (digits only)', example: '07951999999' },
        { key: 'business_email', label: 'Business email', example: 'info@chartersgold.co.uk' },
        { key: 'address', label: 'Business address', example: 'Index House, Ascot…' },
        { key: 'logo_url', label: 'Brand logo URL', example: 'https://chartersgold.co.uk/logo/charters_gold_logo.png' },
        { key: 'site_url', label: 'Public site URL', example: 'https://chartersgold.co.uk' },
      ],
...
export function mockAppointmentEvents(): AppointmentEvent[] {
  ...
  return [
    {
      id: 'evt-ascot',
      title: 'Ascot Showroom',
      city: 'Ascot (Head Office)',
      venue_name: 'Index House',
      address: "St George's Lane, Ascot, Berkshire, SL5 7ET",
      postcode: 'SL5 7ET',
      latitude: 51.4084,
      longitude: -0.6726,
      description:
        'Our private valuation rooms in Ascot, Berkshire. Discreet, by appointment, with same-day payment available.',
