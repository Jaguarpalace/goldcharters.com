...
const SEO_DEFAULTS: Record<string, { title: string; description: string }> = {
  ...
  '/sell-antique-jewellery': {
    ...
    description:
      'Sell antique and vintage jewellery: Victorian, Edwardian, Art Deco and signed pieces valued on period and provenance, never scrap weight. Paid the same day.',
  },
  '/sell-handbags': {
  ...
  '/contact': {
    ...
    description:
      'Speak with a Charters Gold specialist. Telephone, email, WhatsApp or in-person appointment in Ascot, Berkshire.',
  },
  '/book': {
    title: 'Book a Private Appointment · Gold & Jewellery Valuations',
    description:
      'Reserve a private valuation slot at our Ascot office or at your home. Pick a date and time, meet a specialist in person, no obligation to sell.',
  },
  '/blog': {
  ...
  '/gold-calculator': {
    // 58 chars — Google truncates titles around 60, and "Price Per Gram"
    // is the money phrase, so it must survive the cut.
    title: 'Scrap Gold Calculator · 9ct, 18ct & 22ct Price Per Gram UK',
    description:
