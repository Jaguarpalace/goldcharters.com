...
export const ascot: LocationContent = {
  slug: 'ascot',
  name: 'Ascot',
  region: 'Berkshire',
  ...
  commonPieces: {
    title: 'Pieces we frequently value for Ascot clients',
    body: 'Racing-themed brooches and signed pieces from Royal Ascot, presentation watches (engraved by sponsors or trainers), equestrian-motif jewellery from local stud and polo connections, Rolex Daytona and Cellini, Patek Philippe Calatrava and Aquanaut, signed Cartier and Boodles pieces, antique brooches from older Sunningdale families, gold sovereigns, and designer handbags from regular race-week wardrobes.',
  },
  ...
  cta: {
    title: 'Begin your Ascot valuation',
    body: 'Send photographs and a short description through the valuation form and a specialist will respond within one working day. Particularly happy to discuss racing-related pieces in detail.',
  },
};
