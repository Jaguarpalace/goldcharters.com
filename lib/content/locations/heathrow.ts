...
export const heathrow: LocationContent = {
  ...
  cta: {
    ...
    body: 'WhatsApp is the fastest channel for airport-area clients on tight timing. Where the diary allows, a specialist will confirm a same-day slot and a guide figure within an hour.',
  },
};
