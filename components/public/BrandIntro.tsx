...
const DEFAULT_BODY = `Charters Gold is an independent UK precious-metal buyer based in Ascot, Berkshire, specialising in the discreet valuation and purchase of gold, fine jewellery, luxury watches and designer handbags. Every piece is assessed in person by an experienced specialist - never weighed in a window or priced by an algorithm - so the offer you receive reflects what your gold and jewellery are genuinely worth on today's market.

Our approach is built around three principles: a fair price at the rate we pay today, which follows the gold market, total transparency about how that price is calculated, and same-day payment by bank transfer the moment you accept. Whether you are selling a single inherited ring, a collection of scrap gold, sovereigns, gold bars, a Rolex or Patek Philippe watch, or a pre-loved Hermès or Chanel handbag, the process is the same: upload photos and a few details, receive a written valuation within one working day, and choose whether to proceed.

We work by private appointment from our Surrey base and welcome clients from across London and the wider South-East who prefer a quiet, considered service over a busy high-street counter. Use the gold calculator below for an instant guide price per gram across 9ct, 14ct, 18ct, 22ct and 24ct gold, then request a private valuation when you are ready for a firm offer.`;
